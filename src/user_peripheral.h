...
/* JAEM 전용 Define */
#define APP_SYSTICK_TIMER_DELAY	400   // 400 * 10ms = 4 sec
#define CONNECTED_SLEEP_TIMER_DELAY 1000
...
#define APP_ADV_DATA_UPDATE_TO              (990)  // 1000*10ms = 10sec // user_config.h 의 user_default_hnd_conf 의 advertise_period 값에서 -10 줄 것
