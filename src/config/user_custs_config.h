...
#define DEF_CUST1_CTRL_POINT_CHAR_LEN     2
#define DEF_CUST1_LED_STATE_CHAR_LEN      1
#define DEF_CUST1_ADC_VAL_1_CHAR_LEN      2
#define DEF_CUST1_ADC_VAL_2_CHAR_LEN      1
#define DEF_CUST1_BUTTON_STATE_CHAR_LEN   2
...
#define CUST1_ADC_VAL_1_USER_DESC         "Value 1"
#define CUST1_ADC_VAL_2_USER_DESC         "Value 2"
...
enum
{
    ...
    CUST1_IDX_CONTROL_POINT_VAL,
		CUST1_IDX_CONTROL_POINT_NTF_CFG,
...
static const struct att_char128_desc custs1_ctrl_point_char       = {ATT_CHAR_PROP_WR | ATT_CHAR_PROP_RD,
                                                                     {0, 0},
...
static const struct att_char128_desc custs1_adc_val_2_char        = {ATT_CHAR_PROP_RD | ATT_CHAR_PROP_NTF,
                                                                     {0, 0},
...
static const struct attm_desc_128 custs1_att_db[CUST1_IDX_NB] =
{
    ...
    // Control Point Characteristic Value (ex. WR/ENABLE 이라면 쓰기값만 전달됨; RD/ENABLE 이라면 읽기값만 전달됨)
    [CUST1_IDX_CONTROL_POINT_VAL]       = {CUST1_CTRL_POINT_UUID_128, ATT_UUID_128_LEN, PERM(WR, ENABLE) | PERM(RD, ENABLE),
                                            DEF_CUST1_CTRL_POINT_CHAR_LEN, 0, NULL},
	  // Control Point Characteristic Client Characteristic Configuration Descriptor
    [CUST1_IDX_CONTROL_POINT_NTF_CFG]       = {(uint8_t*)&att_decl_cfg, ATT_UUID_16_LEN, PERM(WR, ENABLE) | PERM(RD, ENABLE),
   ...
   // ADC Value 1 Characteristic Declaration
    ...
    [CUST1_IDX_ADC_VAL_1_VAL]           = {CUST1_ADC_VAL_1_UUID_128, ATT_UUID_128_LEN, PERM(NTF, ENABLE),
    ...
    [CUST1_IDX_ADC_VAL_2_VAL]           = {CUST1_ADC_VAL_2_UUID_128, ATT_UUID_128_LEN, PERM(NTF, ENABLE),
                                            DEF_CUST1_ADC_VAL_2_CHAR_LEN, 0, NULL},
    // ADC Value 2 Client Characteristic Configuration Descriptor
    [CUST1_IDX_ADC_VAL_2_NTF_CFG]       = {(uint8_t*)&att_decl_cfg, ATT_UUID_16_LEN, PERM(RD, ENABLE) | PERM(WR, ENABLE),
                                            sizeof(uint16_t), 0, NULL},
