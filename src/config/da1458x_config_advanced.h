...
/* padded with 0. The second option is used for production builds where the NVDS area in OTP or non-volalite    */
/* memory are written in manufcaturing procedure                                                                */
/****************************************************************************************************************/
    #define CFG_INITIALIZE_NVDS_STRUCT

/****************************************************************************************************************/
/* Low Power clock selection.                                                                                   */
/*      -LP_CLK_XTAL32      External XTAL32 oscilator                                                           */
...
/* where XTAL16M is calibrated and trim value is stroed in OTP.                                                 */
/* Importand note. The hardocded value is the average value of the trimming values giving the optimal results   */
...
/***************************************************************************************************************/
/* Enables True Random number Generator. A random number is generated at system initiliasation and used to seed*/
...
/* If CFG_MEM_MAP_EXT_SLEEP or no sleep mode is selected the heap memory sizes are automaticaly configured      */
...
/*  -   USE_MEMORY_MAP  Memory configuration based on sleep mode. Determines if specifc data areas can be       */
/*      located in SysRAM or not.                                                                               */
/*  -   REINIT_DESCRIPT_BUF  Reinitilize BLE messages' descriptors at wakeup from Deep Sleep mode               */
/*  -   DB_HEAP_SZ  ATT database Heap Size                                                                      */
/*  -   ENV_HEAP_SZ Envroment structures Heap Size                                                              */
/*  -   MSG_HEAP_SZ Message Heap Size                                                                           */
/*  -   NON_RET_HEAP_SZ Non rettention Heap Size                                                                */
/****************************************************************************************************************/
/*
...
/*                                      ignored                                                                 */
/* - CFG_NVDS_TAG_LPCLK_DRIFT           Low power clock drift                                                   */
...
/****************************************************************************************************************/
#define CFG_NVDS_TAG_BD_ADDRESS             {0x61, 0x52, 0x43, 0x34, 0x25, 0x16}
...
/****************************************************************************************************************/
/* Enables the logging of heap memories usage. The fature can be used in development/debug mode                 */
...
/****************************************************************************************************************/
/* Enables WLAN coexistance sinalling interface.                                                                 */
/****************************************************************************************************************/
#undef CFG_WLAN_COEX        
